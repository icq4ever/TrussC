...
void tcApp::setup() {
    logNotice("tcApp") << "=== textureExample ===";
    logNotice("tcApp") << "Texture Filter & Wrap Mode Demo";
    logNotice("tcApp") << "[UP/DOWN] Change scale";
    logNotice("tcApp") << "[1] Scale 4x  [2] Scale 8x  [3] Scale 16x  [4] Scale 32x";
...
void tcApp::keyPressed(int key) {
    if (key == SAPP_KEYCODE_UP) {
        ...
        logNotice("tcApp") << "Scale: " << scale_ << "x";
