...
- `void SoundBuffer::createAdtsHeader(uint8_t * header, int frameLength, int sampleRate, int channels, int profile = …)`
...
- `int SoundBuffer::getAdtsSampleRateIndex(int sampleRate)`
